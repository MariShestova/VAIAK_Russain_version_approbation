...
```
VAIAK_Russian_version_approbation/
│
├── data/
│   ├── VAIAK_approbation.csv          # Main dataset (N = 714)
│   ├── sample_300.csv                 # Dataset for EFA (n = 300)
│   └── sample_remaining.csv           # Dataset for MGCFA
│
├── scripts/
│   ├── EFA_CFA_MGFA_VAIAK_Rus_2026.R  # EFA, CFA, Omega, MGCFA
│   ├── IRT_VAIAK_Rus_2026.R           # Multi-group IRT, DIF, ESSD
│   └── Test_Norms_VAIAK_Rus_2026.R    # Test norms calculation
│
├── output/
│   ├── tables/
│   │   ├── Table2_Novice_PartA.csv
│   │   ├── Table3_Expert_PartA.csv
│   │   ├── Table4_PartB_Total.csv
│   │   ├── Table4_PartC_Total.csv
│   │   ├── efa_3_factors_sorted.csv
│   │   ├── CFA_results.csv
│   │   └── MGCFA_results.csv
│   ├── plots/
│   │   └── scree_parallel_plots.png
│   └── logs/
│       └── analysis_log.txt
│
├── README.md
...
All analyses were performed in **R version 4.5.2**. Required packages:

```r
install.packages(c(
  "psych",      # EFA, KMO, Omega
  "lavaan",     # CFA, MGCFA
  "semTools",   # Fit measures for MGCFA
  "mirt",       # IRT models, DIF, ESSD
...
ORCID: [0000-0002-0750-1989](https://orcid.org/0000-0002-0750-1989)
